...
alias m0869_129='cd ~/Documents/source/work_git/M0869_129/source'
...
#prv todo's at entering into folder
PROMPT_COMMAND='
if test "$TODO_SHOW_CWD" != "$PWD";
then export TODO_SHOW_CWD="$PWD";
    if test -f .todo2 ;
    then
        tput setaf 3;
        echo "$PWD";
    ...
    if test -f .env_cfg
    then
        echo "Enviromental cfg file loaded";
        source .env_cfg
    fi;
fi'
